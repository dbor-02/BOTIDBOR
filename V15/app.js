...
function renderSalesReport() {
    ...
    if (showMoreInfo) {
        ...
        html += `
            ...
            <!-- Estadísticas por método de pago - CON TRANSFERENCIA MODIFICADA PARA MÓVIL -->
            <div class="grid grid-cols-3 gap-2 md:gap-4">
                ${Object.entries(paymentMethods).map(([method, data]) => {
                    ...
                    // Acortar "Transferencia" a "Transf" en móvil
                    ...
                    <div class="bg-surface border border-border rounded-xl p-2 md:p-4 flex flex-col items-center">
                        <div class="flex flex-col items-center gap-1 mb-2">
                            ...
                            <span class="text-textMuted text-xs md:text-base text-center">${displayName}</span>
                        </div>
